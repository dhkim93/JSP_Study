...
public class ParkingDao {
	public int enroll(String tno, String carno, String phone, String grade, String tstat, String startdate, String enddate) throws NamingException, SQLException{
		...
		int res = 0;
		try {
			String queryInsert = "insert into park_tbl_01(tno, carno, phone, grade, tstat, startdate, enddate) values (?, ?, ?, ?, ?, ?, ?)";
	...
	public ArrayList search(){
		...
		try {
			...
			while (rs.next()) {
				...
				pVO = new ParkingDao(rs.getString(1), rs.getString(2), rs.getString(3), grade, rs.getString(5), rs.getString(6), rs.getString(7));
